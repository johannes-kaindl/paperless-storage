...
Derselbe Umgebungsvertrag gilt für `scripts/gui-smoke.ts -- --setup` (s. `docs/SMOKE.md`):
der getrackte Fixture-Vault (`docs/images/fixture/`) enthält nie Zugangsdaten, die kommen
